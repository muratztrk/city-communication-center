...
- **Vatandaş Talep Haritası (#2572/#2569):** `/citizen-request-map`; `GET /reports/dashboard-citizen-map-pins`;
  ...
  Google haritada cadde/sokak/bulvar etiketleri açık; tüm Google POI kapalı; CBS Tire referans
  yerleri kategori renkli daire ikon + isim etiketi (zoom≥15) ve mahalle adları overlay (#2793/#2796).
