...
const statusPillVariants = cva('status-pill inline-flex items-center justify-center text-center rounded-full px-2.5 py-1 text-[0.72rem] font-semibold ring-1', {
  variants: {
    tone: {
