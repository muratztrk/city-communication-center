      ...
      {active.map(tpl => (
        ...
        >
          <span className="min-w-0">
            ...
            <p className="mt-0.5 truncate text-[11px] text-[color:var(--color-muted-foreground)]">{tpl.content}</p>
          </span>
        </button>
      ))}
    </div>,
      ...
      <Button
        ...
        className={
          isOnDark
            ...
            : `${compact ? 'h-7 gap-1 px-2 text-[11px]' : 'h-9 px-2.5 text-xs'} gap-1 font-semibold disabled:opacity-50`
        }
      >
