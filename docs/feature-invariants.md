...
- **Dosya sunucusu test alanları (#6a6cb6ec):** NAS ve FTP kolonlarında ayrı bağlantı +
  ...
  altında çizgi yok; saat alanı tarayıcının kendi saat kutusudur (özel saat listesi yok, #6ab639df geri alındı).
...
- **Reporter vatandaş anasayfa (#2519):** pie grid son kutusu `Bildirimler` — son 3 bildirim (sıra no),
  ...
  `max-height` ile ikinci satırı kesmez; sayfa numarası ve oklar sola dayalıdır.
