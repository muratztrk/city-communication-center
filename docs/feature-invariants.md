...
- **Vatandaş Talep Haritası (#2572/#2569):** `/citizen-request-map`; `GET /reports/dashboard-citizen-map-pins`;
  ...
  Google haritada cadde/sokak/bulvar açık; ticari POI kapalı; okul/hastane/cami/kamu/park/gar
  vb. Google Maps native POI katmanı (school/medical/place_of_worship/government/park/sports_complex/
  cemetery/lodging + transit.station); CBS overlay veya özel referans marker yok (#2796).
