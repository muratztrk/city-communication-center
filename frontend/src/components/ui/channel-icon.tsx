    ...
    case 'WhatsApp':
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="WhatsApp">
          <path
            d="M12 2C6.477 2 2 6.477 2 12c0 1.89.524 3.66 1.438 5.168L2 22l4.978-1.395A9.935 9.935 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2z"
            fill="#25D366"
          />
          <path
            d="M16.5 14.5c-.25.75-1.5 1.5-2.25 1.5C11.5 16 9 13.5 8 11.25c0-.75.5-2 1.25-2.25.5-.25 1 0 1.25.5l.75 1.5c.25.5 0 1-.25 1.25l-.25.25c.5 1 1.75 2.25 2.75 2.75l.25-.25c.25-.25.75-.5 1.25-.25l1.5.75c.5.25.75.75.5 1.25z"
            fill="white"
          />
        </svg>
      )
