...
- **Grid thead + paging sabit yükseklik (#2824):** sayfa boyutu değişince başlık şeridi büyümemeli —
  ...
  Görevler / Vatandaş ve SMS mesaj onayı / Vatandaş Bilgi Listesi tablolarında sütunlar arası tek
  gradient için `fixed` kullanılır (#r447). Pie drilldown popup grid (`dashboard-drilldown-table`) aynı kalıp —
