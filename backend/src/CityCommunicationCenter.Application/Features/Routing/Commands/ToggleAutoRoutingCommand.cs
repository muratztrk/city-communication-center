...
public sealed class ToggleAutoRoutingCommandHandler : IRequestHandler<ToggleAutoRoutingCommand, Unit>
{
    ...
    public async Task<Unit> Handle(ToggleAutoRoutingCommand request, CancellationToken cancellationToken)
    {
