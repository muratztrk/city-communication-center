...
- **Sol menüde `/whatsapp` alt linki `SidebarNavLinkItem.emphasized` ile biraz büyük kalır**;
  tüm sidebar font/zoom ölçeğini değiştirerek diğer menüleri büyütme (card #1085).
