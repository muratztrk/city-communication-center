...
- **Vatandaş Talep Haritası (#2572/#2569):** `/citizen-request-map`; `GET /reports/dashboard-citizen-map-pins`;
  ...
  Google haritada cadde/sokak/bulvar açık; Google POI kapalı; karttaki referans yerler (okul,
  hastane, cami, kamu, park, gar vb.) yalnızca CBS isim filtresi + kategori daire ikon overlay;
  zoom≥14 yükleme, zoom≥15 isim etiketi (#2796).
