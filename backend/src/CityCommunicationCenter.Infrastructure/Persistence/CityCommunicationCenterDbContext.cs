...
public sealed class CityCommunicationCenterDbContext : DbContext, IApplicationDbContext
{
    ...
    private static void ConfigureSocialConversationEntry(EntityTypeBuilder<SocialConversationEntry> builder)
    {
        ...
        builder.Property(e => e.RelayedByDisplayName).HasMaxLength(200);
    ...
    private static void ConfigureSupportRequest(EntityTypeBuilder<SupportRequest> builder)
    {
        builder.ToTable("supportrequests");
        builder.HasKey(entity => entity.SupportRequestId);
