  ...
  return createPortal(
    <>
      <div className="fixed inset-0 z-[90] flex items-center justify-center bg-slate-950/45 p-4" onClick={onClose}>
        <div
          className="detail-modal-shell detail-modal-shell--my-request flex max-h-[min(92dvh,56rem)] w-[min(96vw,90rem)] flex-col overflow-hidden rounded-[var(--radius-2xl)] bg-white shadow-2xl"
