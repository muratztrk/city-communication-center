        ...
        <div className="grid gap-2">
          <label className="grid gap-1 min-h-0">
            <span className="text-sm font-semibold text-slate-500">
              ...
              {hasNeighborhood ? (
                <span className="ml-1 text-xs font-normal text-slate-400">{t('address.openAddressMaxHint', '(max 400 karakter)')}</span>
              ) : null}
            </span>
            <textarea
    ...
    <div className="page-stack desktop-page-shell">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-slate-600">{t('requests.create.internalDescription', 'Kendi biriminizde olan talep sürecini oluşturun.')}</p>
                  </div>
                </div>
              </button>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-slate-600">{t('requests.create.citizenDescription', 'Vatandaştan gelen talebi manuel oluşturun.')}</p>
                </div>
              </div>
            </button>
          ) : null}
        ...
        <form id="internal-request-form" noValidate className="section-card request-form request-form--readable grid min-w-0 max-w-full gap-4 xl:grid-cols-2" onSubmit={handleCreateInternal}>
          ...
          <div className="grid content-start gap-3">
            <div className="job-field min-h-0">
              <span className="job-field-label">{t('tasks.newRequest.description', 'Açıklama')} <span className="normal-case text-xs font-normal text-slate-400">(max 400 karakter)</span> <span className="text-red-500">*</span></span>
              <RichTextEditor
      ...
      {selectedKind === 'external' ? (
        <form id="external-request-form" noValidate className="section-card request-form request-form--readable grid min-w-0 max-w-full gap-3 xl:grid-cols-2" onSubmit={handleCreateExternal}>
          ...
          <div className="grid content-start gap-3">
            <div className="job-field min-h-0">
              <span className="job-field-label">{t('jobs.form.description')} <span className="normal-case text-xs font-normal text-slate-400">(max 400 karakter)</span> <span className="text-red-500">*</span></span>
              <RichTextEditor
          ...
          <div className="grid content-start gap-3">
            <div className="grid gap-3 md:grid-cols-2">
              <label className="job-field">
                <span className="job-field-label">{t('settings.citizen.citizenName', 'Vatandaş Adı')} <span className="text-red-500">*</span></span>
                <input
              ...
              <label className="job-field">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  />
                  <input
                    className="field-input min-w-0 flex-1 text-[0.875rem] placeholder:text-[0.875rem]"
                    required
                    inputMode="numeric"
