          ...
          <div className="grid gap-4 xl:grid-cols-2">
            <form className="section-card page-stack" onSubmit={saveTenantLdap}>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <label className="inline-flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-semibold text-slate-700">
                  <input className="field-checkbox" checked={tenantLdapSettings.autoProvisionUsers} disabled={!tenantLdapSettings.enabled} type="checkbox" onChange={event => setTenantLdapSettings(current => ({ ...current, autoProvisionUsers: event.target.checked }))} />
                  {t('settings.ldapAutoProvision')}
                </label>
              </div>
              <div className="grid gap-4 md:grid-cols-2">
                <label className="grid gap-2 text-sm font-semibold text-slate-700">
