            ...
            <table className="data-table jobs-table data-table--zebra">
              <thead>
                <tr>
                  ...
                  <FilterableTh filterKey="sokakCaddeAdi" filterValue={filters.sokakCaddeAdi ?? ''} onFilter={setFilter} sortKey="sokakCaddeAdi" currentSortKey={sortKey} sortDir={sortDir} onSort={toggleRowSort}>{t('edevletActivityPlans.columns.street', 'Cadde/Sokak')}</FilterableTh>
