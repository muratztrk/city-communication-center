...
function useResponsiveZoom() {
  const compute = () => {
    ...
    if (w >= 1920) return { sidebar: 0.90, content: 0.96 }
    if (w >= 1680) return { sidebar: 1.0, content: 1.0 }
...
export function AppShell() {
  ...
  const navItemConfigs: NavLinkConfigEx[] = [
    ...
    { pageKey: 'social' as const, path: '/whatsapp', label: 'WhatsApp', icon: MessageCircle },
