...
- **Vatandaş Talep Haritası (#2572/#2569):** `/citizen-request-map`; `GET /reports/dashboard-citizen-map-pins`;
  ...
  Google haritada cadde/sokak/bulvar açık; ticari POI kapalı; okul/hastane/cami/kamu bina/park/
  mezarlık/gar/istasyon/yurt/stad Google native POI ikonları açık; CBS overlay yok (#2796; #2797/#2793 geri alındı).
