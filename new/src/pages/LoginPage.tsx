  ...
  return (
    <div className="min-h-dvh px-4 py-4 lg:px-6 lg:py-4">
      <div className="mx-auto grid min-h-[calc(100dvh-2rem)] max-w-[1320px] overflow-hidden rounded-[calc(var(--radius-2xl)+0.3rem)] border border-white/60 shadow-[var(--shadow-soft)] lg:grid-cols-[minmax(0,1fr)_400px]">
          ...
          <div className="relative flex h-full flex-col justify-between gap-8 lg:gap-6">
            <div className="space-y-5">
              <div className="space-y-3">
                <h1 className="max-w-2xl text-4xl font-extrabold leading-[1.04] text-white sm:text-5xl">{institutionName}</h1>
        ...
        <section className="flex items-center justify-center bg-[color:var(--color-surface)]/92 px-5 py-6 sm:px-7 lg:px-6">
          <div className="w-full max-w-[25rem] space-y-5">
            <div className="space-y-2">
              <h2 className="text-3xl font-extrabold text-slate-950">{t('login.formTitle')}</h2>
