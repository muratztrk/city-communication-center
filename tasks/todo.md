...
- **#3310:** Tamamlanan/Yapılmakta/Onay Bekleyen Talepler + Tamamlanan/Yapılmakta Projeler pie’de Durum sütunu yok.
...
- **Atlandı:** #3232 Tim mobil app (poll anında Doing’de yoktu).
...
- **STATUS:** pushed `9fd53b9f`; 10 kart Done; Doing: 0.
...
## Round 974 — #2799 (yeniden)
- [x] `6a830066` — Yalnız cadde/sokak/bulvar; POI ve transit kapalı (#2796 POI geri alındı).
...
- [x] `6a816550` — Mahalle/cadde boş + Maps linki: Google araması + lat/lng kaydı, haritada pin.
...
- Açıklama font `0.8rem`; Enter satır boşluğu eşit `0.25rem`.
...
- `#2381`/`#2392` reopen: Birim dropdown Sadece Kurum İçi İlet butonunun hemen solunda.
...
- `#6a6da028`: yazdır Tamamlanma Tarihi → Sonuç Tarihi (tüm pie)
...
- #1867 Tire haritası scroll-zoom yalnız tıklama sonrası
...
- #1748: Kullanıcılar “Tüm LDAP Kullanıcılarını Ekle”; eksik birimde hiçbirini ekleme + uyarı; `GET /users/directory-users`.
...
## Round 246 (Doing — 2026-07-07, yeni kartlar devam)
...
## Round 295 (Doing — 2026-07-13, vatandaş adı/telefon ve şablon boşluk girişi)
- [x] `6a54e97d6132f3e117729b8c` / #1596 — Görevlerim, Birimdeki Görevler ve Personelimin Görevleri
  ilgili vatandaş talebi detayında vatandaş adı üstte, telefon numarası altta gösterilir.
- [x] `6a54cbb8fe5dcd8a33b04545` / #1594 reopen — Otomatik cevap gövde ve son ek textarea'ları
