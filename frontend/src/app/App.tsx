...
const WhatsAppMessageApprovalLogsPage = lazy(() => import('../pages/WhatsAppMessageApprovalLogsPage').then(module => ({ default: module.WhatsAppMessageApprovalLogsPage })))
    ...
    <Suspense fallback={<LoadingScreen />}>
      <Routes>
        ...
        <Route element={<AppShell />}>
          ...
          <Route path="/whatsapp-message-approval-logs" element={<PageAccessGate pageKey="whatsappMessageApprovalLogs" user={user}><WhatsAppMessageApprovalLogsPage /></PageAccessGate>} />
