...
export function ScrollFab() {
  ...
  return (
    <button
      ...
      className="scroll-fab-button flex size-11 shrink-0 cursor-pointer items-center justify-center rounded-full bg-[color:var(--color-primary)] text-white shadow-lg transition-all duration-200 hover:scale-110 hover:bg-[var(--color-secondary)] hover:shadow-xl active:scale-95"
    >
      <span
